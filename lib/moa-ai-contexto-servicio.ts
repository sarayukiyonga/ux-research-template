...
- Si el prompt incluye la **entrevista a ${CLIENT.ownerFirstName} (${CLIENT.ownerRole})**, úsala como **fuente de verdad** sobre cómo opera ${CLIENT.name} (qué se hace en persona vs a distancia, mensajes de marca, tipo de clientela). Alinea narrativas, canales y escenas con esa entrevista y con el resto de datos del prompt; no la contradigas con un estereotipo de negocio digital.`
